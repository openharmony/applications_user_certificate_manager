...
declare namespace certificateManager {
    ...
    function removeGrantedPublicCertificate(keyUri: string, clientAppUid: number) : Promise<boolean>;
    ...
    function getUkeyCertificateList(ukeyProvidor: string, ukeyInfo: UkeyInfo): Promise<CMResult>;
